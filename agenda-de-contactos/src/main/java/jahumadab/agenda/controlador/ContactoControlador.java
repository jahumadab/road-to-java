package jahumadab.agenda.controlador;
...
import jahumadab.agenda.servicio.ContactoServicio;
...
public class ContactoControlador {
    ...
    private static final Logger logger = (Logger) LoggerFactory.getLogger(ContactoControlador.class);
